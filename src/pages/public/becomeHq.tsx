                    ...
                    {step === 2 && (
                        <div className="grid gap-4">
                            <div className="grid gap-2">
                                ...
                                <Input id="name" value={formData.name} onChange={handleChange} placeholder="Mon Siège Agisa" className="bg-slate-800 border-slate-700 text-white focus:border-emerald-500" />
                            </div>
                            <div className="grid gap-2">
                                ...
                                <Select onValueChange={(val) => setFormData((prev) => ({ ...prev, type: val }))} value={formData.type}>
                                    <SelectTrigger id="type" className="bg-slate-800 border-slate-700 text-white focus:ring-emerald-500">
                        ...
                        <div className="grid gap-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="grid gap-2">
                                    ...
                                    <Input id="adresseLigne1" value={formData.adresseLigne1} onChange={handleChange} placeholder="734, rue sylvestre" className="bg-slate-800 border-slate-700 text-white focus:border-purple-500" />
                                </div>
                                <div className="grid gap-2">
                                    <Label htmlFor="sectionCommunale" className="text-slate-300">Section Communale</Label>
                                    <Input id="sectionCommunale" value={formData.sectionCommunale} onChange={handleChange} placeholder="Sanyago" className="bg-slate-800 border-slate-700 text-white focus:border-purple-500" />
                                </div>
                            </div>
                            <div className="grid gap-2">
                                <Label htmlFor="proof" className="text-slate-300">Registration Proof (ID or Payment Receipt)</Label>
                                <div className="relative flex flex-col items-center justify-center p-6 border-2 border-dashed border-slate-700 rounded-lg hover:border-purple-500 transition-colors">
